...
from reachy_mini_conversation_app.models.stm_asr import (
    AsyncTranscriber,
    HypothesisBuffer,
    FasterWhisperConf,
)
from reachy_mini_conversation_app.models.stm_diar.config import FRAME_DURATION_S
...
def _diar_worker(
    ...
    from reachy_mini_conversation_app.models.stm_diar import StreamingDiarizer
